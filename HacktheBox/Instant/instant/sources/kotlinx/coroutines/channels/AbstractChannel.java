...
public abstract class AbstractChannel<E> extends AbstractSendChannel<E> implements Channel<E> {
    ...
    */
    ...
    public final Object mo1654tryReceivePtdJZtk() {
        Object pollInternal = pollInternal();
        return pollInternal == AbstractChannelKt.POLL_FAILED ? ChannelResult.INSTANCE.m1674failurePtdJZtk() : pollInternal instanceof Closed ? ChannelResult.INSTANCE.m1673closedJP2dKIU(((Closed) pollInternal).closeCause) : ChannelResult.INSTANCE.m1675successJP2dKIU(pollInternal);
    }
    ...
    public void onCancelIdempotent(boolean wasClosed) {
        ...
        while (true) {
            ...
            if (!(prevNode instanceof LockFreeLinkedListHead)) {
                ...
                mo1652onCancelIdempotentListww6eGU(m1691constructorimpl$default, closedForSend);
                return;
            }
        }
    }
            ...
            while (true) {
                ...
                if (pollInternal instanceof Closed) {
                    ...
                    if (closed.closeCause == null) {
                        ...
                        cancellableContinuationImpl.resumeWith(Result.m148constructorimpl(Boxing.boxBoolean(false)));
                    } else {
                        Result.Companion companion2 = Result.INSTANCE;
                        cancellableContinuationImpl.resumeWith(Result.m148constructorimpl(ResultKt.createFailure(closed.getReceiveException())));
                    }
    ...
    public static class ReceiveElement<E> extends Receive<E> {
        ...
        public void resumeReceiveClosed(Closed<?> closed) {
            if (this.receiveMode == 1) {
                ...
                ChannelResult m1660boximpl = ChannelResult.m1660boximpl(ChannelResult.INSTANCE.m1673closedJP2dKIU(closed.closeCause));
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuation.resumeWith(Result.m148constructorimpl(m1660boximpl));
                return;
            }
            CancellableContinuation<Object> cancellableContinuation2 = this.cont;
            Result.Companion companion2 = Result.INSTANCE;
            cancellableContinuation2.resumeWith(Result.m148constructorimpl(ResultKt.createFailure(closed.getReceiveException())));
        }
