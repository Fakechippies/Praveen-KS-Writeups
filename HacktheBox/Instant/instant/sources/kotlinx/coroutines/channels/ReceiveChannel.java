...
public interface ReceiveChannel<E> {
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) {
            Object mo1654tryReceivePtdJZtk = receiveChannel.mo1654tryReceivePtdJZtk();
            if (ChannelResult.m1670isSuccessimpl(mo1654tryReceivePtdJZtk)) {
                return (E) ChannelResult.m1666getOrThrowimpl(mo1654tryReceivePtdJZtk);
            }
            Throwable m1664exceptionOrNullimpl = ChannelResult.m1664exceptionOrNullimpl(mo1654tryReceivePtdJZtk);
            if (m1664exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(m1664exceptionOrNullimpl);
        }
