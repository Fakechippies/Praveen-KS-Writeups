...
public interface SendChannel<E> {
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            Object mo1655trySendJP2dKIU = sendChannel.mo1655trySendJP2dKIU(e);
            if (ChannelResult.m1670isSuccessimpl(mo1655trySendJP2dKIU)) {
                return true;
            }
            Throwable m1664exceptionOrNullimpl = ChannelResult.m1664exceptionOrNullimpl(mo1655trySendJP2dKIU);
