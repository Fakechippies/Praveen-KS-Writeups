...
final class ReceiveChannel$onReceiveOrNull$1$registerSelectClause1$1<E, R> extends SuspendLambda implements Function2<ChannelResult<? extends E>, Continuation<? super R>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            Throwable m1664exceptionOrNullimpl = ChannelResult.m1664exceptionOrNullimpl(holder);
            if (m1664exceptionOrNullimpl != null) {
                throw m1664exceptionOrNullimpl;
            }
            Function2<E, Continuation<? super R>, Object> function2 = this.$block;
            Object m1665getOrNullimpl = ChannelResult.m1665getOrNullimpl(holder);
            this.label = 1;
            obj = function2.invoke(m1665getOrNullimpl, this);
