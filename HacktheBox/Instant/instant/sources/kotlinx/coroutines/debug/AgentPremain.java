...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            m148constructorimpl = Result.m148constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m148constructorimpl = Result.m148constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m154isFailureimpl(m148constructorimpl) ? null : m148constructorimpl);
        if (bool != null) {
