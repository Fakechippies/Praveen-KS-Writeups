...
public final class UProgressionUtilKt {
    ...
    private static final int m1366differenceModuloWZ9TVnA(int i, int i2, int i3) {
        ...
        int m243constructorimpl = UInt.m243constructorimpl(remainderUnsigned - remainderUnsigned2);
        return compareUnsigned >= 0 ? m243constructorimpl : UInt.m243constructorimpl(m243constructorimpl + i3);
    }
    ...
    private static final long m1367differenceModulosambcqE(long j, long j2, long j3) {
        ...
        long m322constructorimpl = ULong.m322constructorimpl(remainderUnsigned - remainderUnsigned2);
        return compareUnsigned >= 0 ? m322constructorimpl : ULong.m322constructorimpl(m322constructorimpl + j3);
    }

    /* renamed from: getProgressionLastElement-Nkh28Cs, reason: not valid java name */
    public static final int m1369getProgressionLastElementNkh28Cs(int i, int i2, int i3) {
        if (i3 > 0) {
            return Integer.compareUnsigned(i, i2) >= 0 ? i2 : UInt.m243constructorimpl(i2 - m1366differenceModuloWZ9TVnA(i2, i, UInt.m243constructorimpl(i3)));
        }
        if (i3 < 0) {
            return Integer.compareUnsigned(i, i2) <= 0 ? i2 : UInt.m243constructorimpl(i2 + m1366differenceModuloWZ9TVnA(i, i2, UInt.m243constructorimpl(-i3)));
        }
    ...
    public static final long m1368getProgressionLastElement7ftBX0g(long j, long j2, long j3) {
        if (j3 > 0) {
            return Long.compareUnsigned(j, j2) >= 0 ? j2 : ULong.m322constructorimpl(j2 - m1367differenceModulosambcqE(j2, j, ULong.m322constructorimpl(j3)));
        }
        if (j3 < 0) {
            return Long.compareUnsigned(j, j2) <= 0 ? j2 : ULong.m322constructorimpl(j2 + m1367differenceModulosambcqE(j, j2, ULong.m322constructorimpl(-j3)));
        }
        throw new IllegalArgumentException("Step is zero.");
    }
}
