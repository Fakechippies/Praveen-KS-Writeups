...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    public int hashCode() {
        ...
        long j = this.first;
        int m322constructorimpl = ((int) ULong.m322constructorimpl(j ^ ULong.m322constructorimpl(j >>> 32))) * 31;
        long j2 = this.last;
        int m322constructorimpl2 = (m322constructorimpl + ((int) ULong.m322constructorimpl(j2 ^ ULong.m322constructorimpl(j2 >>> 32)))) * 31;
        long j3 = this.step;
        return m322constructorimpl2 + ((int) ((j3 >>> 32) ^ j3));
    }
    ...
    public String toString() {
        ...
        long j;
        if (this.step > 0) {
            append = new StringBuilder().append((Object) ULong.m368toStringimpl(this.first)).append("..").append((Object) ULong.m368toStringimpl(this.last)).append(" step ");
            j = this.step;
        } else {
            append = new StringBuilder().append((Object) ULong.m368toStringimpl(this.first)).append(" downTo ").append((Object) ULong.m368toStringimpl(this.last)).append(" step ");
            j = -this.step;
        }
