...
public final class UStringsKt {
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        if (Integer.compareUnsigned(data, UInt.m243constructorimpl(255)) > 0) {
            return null;
        }
        return UByte.m160boximpl(UByte.m166constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int data = uIntOrNull.getData();
        if (Integer.compareUnsigned(data, UInt.m243constructorimpl(65535)) > 0) {
            return null;
        }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int m243constructorimpl = UInt.m243constructorimpl(i);
        int i4 = 119304647;
        while (i2 < length) {
            ...
            if (Integer.compareUnsigned(i3, i4) > 0) {
                if (i4 == 119304647) {
                    i4 = Integer.divideUnsigned(-1, m243constructorimpl);
                    if (Integer.compareUnsigned(i3, i4) > 0) {
                    }
                }
                return null;
            }
            int m243constructorimpl2 = UInt.m243constructorimpl(i3 * m243constructorimpl);
            int m243constructorimpl3 = UInt.m243constructorimpl(UInt.m243constructorimpl(digitOf) + m243constructorimpl2);
            if (Integer.compareUnsigned(m243constructorimpl3, m243constructorimpl2) < 0) {
                return null;
            }
            i2++;
            i3 = m243constructorimpl3;
        }
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long m322constructorimpl = ULong.m322constructorimpl(i);
        long j = 0;
        ...
        while (i2 < length) {
            ...
            if (Long.compareUnsigned(j, j2) > 0) {
                if (j2 == 512409557603043100L) {
                    j2 = Long.divideUnsigned(-1L, m322constructorimpl);
                    if (Long.compareUnsigned(j, j2) > 0) {
                    }
                }
                return null;
            }
            long m322constructorimpl2 = ULong.m322constructorimpl(j * m322constructorimpl);
            long m322constructorimpl3 = ULong.m322constructorimpl(ULong.m322constructorimpl(UInt.m243constructorimpl(r13) & 4294967295L) + m322constructorimpl2);
            if (Long.compareUnsigned(m322constructorimpl3, m322constructorimpl2) < 0) {
                return null;
            }
            i2++;
            j = m322constructorimpl3;
        }
